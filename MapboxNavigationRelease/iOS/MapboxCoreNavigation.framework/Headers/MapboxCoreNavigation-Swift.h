...
SWIFT_CLASS_NAMED("EventsManager")
@interface MBEventsManager : NSObject
@property (nonatomic, strong) MMEEventsManager * _Nonnull manager;
- (nonnull instancetype)initWithAccessToken:(NSString * _Nullable)possibleToken OBJC_DESIGNATED_INITIALIZER;
...
enum MBFeedbackSource : NSInteger;

@interface MBEventsManager (SWIFT_EXTENSION(MapboxCoreNavigation))
...
- (NSUUID * _Nonnull)recordFeedbackWithType:(enum MBFeedbackType)type description:(NSString * _Nullable)description SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP20MapboxCoreNavigation33NavigationLocationManagerProtocol_")
@protocol NavigationLocationManagerProtocol <MGLLocationManager>
@property (nonatomic) CLActivityType activityType;
@property (nonatomic, weak) id <MGLLocationManagerDelegate> _Nullable navDelegate;
@property (nonatomic, strong) CLLocation * _Nullable location;
@property (nonatomic, strong) CLLocation * _Nullable lastKnownLocation;
@end
...
@interface MBNavigationLocationManager : NSObject <CLLocationManagerDelegate, NavigationLocationManagerProtocol>
@property (nonatomic) CLLocationDistance distanceFilter;
@property (nonatomic) CLLocationAccuracy desiredAccuracy;
@property (nonatomic) CLActivityType activityType;
@property (nonatomic, strong) id <MGLLocationManagerDelegate> _Nullable delegate;
@property (nonatomic, weak) id <MGLLocationManagerDelegate> _Nullable navDelegate;
...
@protocol Router <MGLLocationManagerDelegate>
@property (nonatomic, readonly, strong) MBEventsManager * _Null_unspecified eventsManager;
@property (nonatomic, readonly, strong) id <NavigationLocationManagerProtocol> _Null_unspecified locationManager;
...
@property (nonatomic, strong) id <NavigationLocationManagerProtocol> _Null_unspecified locationManager;
...
@property (nonatomic, strong) MBEventsManager * _Nonnull eventsManager;
...
///
- (nonnull instancetype)initWithRoute:(MBRoute * _Nonnull)route directions:(MBDirections * _Nonnull)directions locationManager:(id <NavigationLocationManagerProtocol> _Nonnull)locationManager eventsManager:(MBEventsManager * _Nullable)eventsOverride OBJC_DESIGNATED_INITIALIZER;
...
@interface MBRouteController (SWIFT_EXTENSION(MapboxCoreNavigation)) <MGLLocationManagerDelegate>
- (BOOL)locationManagerShouldDisplayHeadingCalibration:(id <MGLLocationManager> _Nonnull)manager SWIFT_WARN_UNUSED_RESULT;
- (void)locationManager:(id <MGLLocationManager> _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
- (void)locationManager:(id <MGLLocationManager> _Nonnull)manager didUpdateHeading:(CLHeading * _Nonnull)newHeading;
- (void)locationManager:(id <MGLLocationManager> _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
