...
class ViewController: UIViewController, MGLMapViewDelegate {
    ...
    var navisensLocationManager = NavisensLocationManager()
    // MARK: Properties
    ...
    func navigationLocationManager() -> NavigationLocationManagerProtocol {
       return self.navisensLocationManager
      
      guard let route = routes?.first else {}//+++ NavigationLocationManager() }
    ...
    func setupMapView() {
        ...
        self.mapView?.locationManager = navisensLocationManager
...
extension ViewController: NavigationViewControllerDelegate {
    ...
    func navigationViewControllerDidDismiss(_ navigationViewController: NavigationViewController, byCanceling canceled: Bool) {
        self.navisensLocationManager.navDelegate = nil
